...
$crafti_theme_required_plugins        = array(
	...
	'quickcal'                     => array(
		'title'       => esc_html__( 'QuickCal', 'crafti' ),
		'description' => '',
		'required'    => false,
		'install'     => false,
		'logo'        => 'quickcal.png',
	...
	'gdpr-framework'         => array(
		'title'       => esc_html__( 'The GDPR Framework', 'crafti' ),
		'description' => esc_html__( "Tools to help make your website GDPR-compliant. Fully documented, extendable and developer-friendly.", 'crafti' ),
		'required'    => false,
		'install'     => false,
...
if ( CRAFTI_THEME_FREE ) {
	...
	unset( $crafti_theme_required_plugins['quickcal'] );
