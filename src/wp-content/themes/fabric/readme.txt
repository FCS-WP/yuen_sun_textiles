...
Please install and activate it before starting to use the theme Fabric.
...
Theme documentation is available on https://fabric.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Fabric is Fontello.
