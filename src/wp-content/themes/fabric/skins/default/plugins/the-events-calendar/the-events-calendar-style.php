...
if ( ! function_exists( 'fabric_tribe_events_get_css' ) ) {
	add_filter( 'fabric_filter_get_css', 'fabric_tribe_events_get_css', 10, 2 );
	function fabric_tribe_events_get_css( $css, $args ) {
