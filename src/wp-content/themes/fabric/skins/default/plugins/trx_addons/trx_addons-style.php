...
if ( ! function_exists( 'fabric_trx_addons_get_css' ) ) {
	add_filter( 'fabric_filter_get_css', 'fabric_trx_addons_get_css', 10, 2 );
	function fabric_trx_addons_get_css( $css, $args ) {
