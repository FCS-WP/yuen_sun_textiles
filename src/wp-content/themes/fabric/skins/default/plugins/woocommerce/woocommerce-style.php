...
if ( ! function_exists( 'fabric_woocommerce_get_css' ) ) {
	add_filter( 'fabric_filter_get_css', 'fabric_woocommerce_get_css', 10, 2 );
	function fabric_woocommerce_get_css( $css, $args ) {
...
$fdir = fabric_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
